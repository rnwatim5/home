...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 08, 2017 at 03:36 PM
...
INSERT INTO `korisnik` (`idkorisnik`, `ime`, `prezime`, `email`, `lozinka`, `razina`) VALUES
(1, 'ivan', 'markic', 'i@mail.com', 12345678, 1),
(2, 'noj', 'nojevic', 'noj@email.com', 12345678, 5);
...
CREATE TABLE `slike` (
  ...
  `artikl_idartikl` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `slike` (`idslike`, `lokacija`, `artikl_idartikl`) VALUES
(3, 'img/ostalo.jpg', 3),
(1, 'img/megle.jpg\r\n', 1),
(2, 'img/sir.jpg', 2),
(4, 'img/ostalo.jpg', 4),
